...
func TemplateEntity(s util.StructDef, v string) (string, error) {
	...
	template += "type Query struct {\n"
	template += "\t*query.Query\n"
	template += "}\n\n"

	template += "func NewQuery() *Query {\n"
	template += "return &Query{Query: query.NewQuery()}\n"
	template += "}\n\n"

	template += "func (x *Query) Execute(c *hconn.HConn) ([]*" + s.Name + ", error) {\n"
	template += "x.SortFilters()" + "\n\n"
	template += "msg := model.Message{\n"

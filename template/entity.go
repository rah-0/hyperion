...
func TemplateEntity(s util.StructDef, v string) (string, error) {
	...
	template += "type DbQuery struct {\n"
	template += "\tQ *query.Query\n"
	template += "}\n\n"

	template += "func NewQuery() *DbQuery {\n"
	template += "return &DbQuery{Q: query.NewQuery()}\n"
	template += "}\n\n"

	template += "func (x *DbQuery) SetFilters(filters query.Filters) *DbQuery {\n"
	template += "x.Q.SetFilters(filters)\n"
	template += "return x\n"
	template += "}\n\n"

	template += "func (x *DbQuery) Execute(c *hconn.HConn) ([]*" + s.Name + ", error) {\n"
	template += "msg := model.Message{\n"
